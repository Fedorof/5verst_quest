...
export class Road extends MDQuest {
    ...
    _btn_поляна = (skip_beregini) => `
        ...
        ${ 
            (this.get("count_чугайстер_танцевать") && !this.get("count_устал_двор"))
    ...
    тропинка4 = () => `
        ...
        ${
            ...
            : this.set("где_то_дальше", "Дальше — брод и водяной")
        }
