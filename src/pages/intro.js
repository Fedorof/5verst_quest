...
export class Intro extends MDQuest {
    ...
    вступ = () => `
        ...
        Руді відблиски вогнища грають на одязі, відсвічують у очах.
        
        
        — Приміром, про козаків: що вони, мовляв, по пояс голі шаблями махають,
        а кожен другий якщо не характерник, то із нечистою силою знається.
        Але ж козаки — рицарі та стрільці, хоч так - на шаблю 
        є багацько вправних. А от характерників — добе, як хоч одного знайдеш.
        Непроста це наука...
    ...
    вступ0 = () => `
        ...
        — Отож, - говорить він, — якщо люди вигадують, то чому б і мені 
        небилицю не розказати? 
        
        Слухачі підсуваються ближче.
        
        — Колись  молодой джура — а був він молодшим від вас —
        повертався на Січ із Лугу. Та, варто сказати, був це не простий
        парубок, бо учився він на характерника.
