...
export class Ford extends MDQuest {
    ...
    checkAnswer = () => {
        ...
        this.set(countName, this.get(countName) + this.get('питання'));
        this.set('питання', 0);
    ...
    брід0 = () => {
        ...
        return `
           ...
            — Ходять тут усякі, — каже, — тільки набридають. З чого мені тебе
            ...
            а коли ні — як знаеш, так і перебирайся!
    ...
    вірно = (answer) => `
        ...
        ${ this.switch(['вірно1', 'вірно2', 'вірно3'], 'count_вірно') }
    `;
    ...
    вірно2 = () => `
        ...
        — Знов вгадав! — каже. — Не такий ти й дурний, як здаєшся... Гаразд,
    ...
    невірно = (answer) => `
        ...
        ${ this.switch(['невірно1', 'невірно2', 'невірно3'], 'count_невірно') }
    `;
    ...
    остання_загадка = () => `
        ...
        — Слухай мою останню загадку, — каже. — "Хто вранці ходить на чотирьох,
    ...
    цирковий_кінь = () => `
        ...
        — Що ви, дядьку, — промовляє парубок — Де ж ви бачили людей із чотирма
        ногами?
    ...
    відгадка_людина0 = () => `        
        ...
        — Правильна — це якщо загадку перекручувати! Ви ще скажіть,
        що "три" — це "два"!
    ...
    відгадка_людина1 = () => `
        ...
        То як я можу розгадувати Ваші загадки, коли в загадці — одне, 
        а у відгадці — інше. 
    ...
    відгадка_людина2 = () => `        
        ...
        — Цю загадку треба по-іншому казати, — говорить він. — Наприклад, 
