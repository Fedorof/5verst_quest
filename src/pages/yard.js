...
export class Yard extends MDQuest {
    ...
    двор = () => `
        ...
        ${ 
            ...
            : dedent`
                ...
                [Идти по тропинке](#road:тропинка${ this.get('статус_нявка', 0) })
                
                [Зайти в стойло](#стойло${ this.get('статус_домовой', 0) })
            `
        }
    `;
    ...
    домовой_загадка = () => `
        ...
        [Дальше](#стойло${ this.get('статус_домовой', 0) })
    `;
